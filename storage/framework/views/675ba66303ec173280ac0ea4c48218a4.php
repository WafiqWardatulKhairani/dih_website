    ...
    <section class="relative text-white py-16 overflow-hidden">
        ...
        <div class="relative container mx-auto px-4 text-center z-10">
            ...
            <div class="bg-white/20 backdrop-blur-md p-3 rounded-lg max-w-2xl mx-auto shadow-lg">
                <form action="<?php echo e(route('kolaborasi.index')); ?>" method="GET" class="flex gap-2">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $kolaborasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="kolaborasi-card">
                    ...
                    <div class="card-image relative">
                        ...
                        <!-- STATUS BADGE -->
                        <span class="status-badge <?php echo e($statusColor); ?> text-white">
                            <?php echo e($status); ?>
                    ...
                    <div class="card-content">
                        <h3 class="card-title line-clamp-2"><?php echo e($k->title); ?></h3>

                        <!-- DESCRIPTION -->
                        <p class="text-xs text-gray-600 mb-2 line-clamp-2"><?php echo e($k->description); ?></p>

                        <!-- OWNER -->
                        <div class="user-info">
                            <i class="fas fa-user"></i>
                            <span class="truncate max-w-[60px]"><?php echo e(Str::limit($k->owner->name ?? 'Anonim', 8)); ?></span>
                        </div>

                        <!-- MEMBERS & TASKS -->
                        <div class="stats-info">
                            <span><i class="fas fa-users"></i> <?php echo e($membersCount); ?></span>
                            <span><i class="fas fa-tasks"></i> <?php echo e($tasks); ?></span>
                        </div>
                        ...
                        <div class="mt-1">
                            <div class="flex justify-between items-center text-xs text-gray-600 mb-1">
                                ...
                                <span class="font-semibold text-[0.6rem]"><?php echo e($progressPercent); ?>%</span>
                            </div>
                        ...
                        <div class="card-meta">
                            <span class="text-[0.6rem] text-gray-500">
                                ...
                                <?php echo e(\Carbon\Carbon::parse($k->created_at)->shortRelativeDiffForHumans()); ?>
