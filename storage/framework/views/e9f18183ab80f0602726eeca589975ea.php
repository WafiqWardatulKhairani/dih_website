            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div class="flex items-center space-x-6 mt-4 md:mt-0">
                    <div class="text-right">
                        ...
                        <div class="text-lg font-semibold text-gray-900"><?php echo e(now()->format('d M Y')); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 md:px-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white text-center p-6 rounded-xl border border-gray-200 card-hover">
                <div class="text-2xl font-bold text-blue-600 mb-2" id="program-counter"><?php echo e($programStats['total_programs']); ?></div>
                <div class="text-gray-600 text-sm font-medium">Total Program</div>
                <div class="text-xs text-green-600 mt-1"><?php echo e($programStats['active_programs']); ?> aktif</div>
            </div>
            <div class="bg-white text-center p-6 rounded-xl border border-gray-200 card-hover">
                <div class="text-2xl font-bold text-green-600 mb-2" id="inovasi-counter"><?php echo e($programStats['total_innovations']); ?></div>
                <div class="text-gray-600 text-sm font-medium">Total Inovasi</div>
                <div class="text-xs text-blue-600 mt-1"><?php echo e($programStats['ready_innovations']); ?> publikasi</div>
            </div>
            <div class="bg-white text-center p-6 rounded-xl border border-gray-200 card-hover">
                <div class="text-2xl font-bold text-purple-600 mb-2" id="progress-counter"><?php echo e(round($averageProgramProgress)); ?>%</div>
            ...
            <div class="bg-white text-center p-6 rounded-xl border border-gray-200 card-hover">
                <div class="text-2xl font-bold text-orange-600 mb-2" id="opd-counter"><?php echo e($programStats['active_opd']); ?></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="relative inline-block mb-4">
                                <svg class="w-24 h-24 progress-ring" viewBox="0 0 100 100">
                                    ...
                                    <circle class="text-blue-600 progress-ring-circle"
                                        ...
                                        data-progress="<?php echo e($averageProgramProgress); ?>"
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span class="text-2xl font-bold text-gray-800"><?php echo e(round($averageProgramProgress)); ?>%</span>
                                </div>
                            </div>
                            ...
                            <div class="relative inline-block mb-4">
                                <svg class="w-24 h-24 progress-ring" viewBox="0 0 100 100">
                                    ...
                                    <circle class="text-green-600 progress-ring-circle"
                                        ...
                                        stroke-dasharray="264"
                                        stroke-dashoffset="264"
                                        data-progress="<?php echo e($innovationImpact); ?>"
                                        stroke-linecap="round"
                                        stroke="currentColor"
                                        fill="transparent"
                                        r="42"
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span class="text-2xl font-bold text-gray-800"><?php echo e(round($innovationImpact)); ?>%</span>
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $programStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="text-lg mr-3">
                                        <?php if($status == 'Berjalan'): ?> 🚀
                                        <?php elseif($status == 'Perencanaan'): ?> 📅
                                        <?php elseif($status == 'Selesai'): ?> ✅
                                        <?php elseif($status == 'Tertunda'): ?> ⏸️
                                        <?php else: ?> 📊
                                        <?php endif; ?>
                                    </span>
                                    <span class="text-sm text-gray-700"><?php echo e($status); ?></span>
                                </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $innovationCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="text-lg mr-3">
                                        <?php if(str_contains(strtolower($category), 'digital')): ?> 💻
                                        <?php elseif(str_contains(strtolower($category), 'layanan')): ?> 🎯
                                        <?php elseif(str_contains(strtolower($category), 'infrastruktur')): ?> 🏗️
                                        <?php elseif(str_contains(strtolower($category), 'proses')): ?> ⚙️
                                        <?php else: ?> 💡
                                        <?php endif; ?>
                                    </span>
                                    <span class="text-sm text-gray-700"><?php echo e($category); ?></span>
                                </div>
                                <span class="text-sm font-semibold text-gray-900"><?php echo e($count); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <span class="text-2xl mr-4"><?php echo e($achievement['icon']); ?></span>
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800"><?php echo e($achievement['achievement']); ?></p>
                                <div class="flex items-center text-xs text-gray-500 mt-1">
                                    <span><?php echo e($achievement['source']); ?></span>
                                    <span class="mx-2">•</span>
                                    <span><?php echo e($achievement['time']); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo e(route('pemerintah.program.create')); ?>" class="flex items-center p-3 rounded-lg border border-blue-200 bg-blue-50 hover:bg-blue-100 transition-colors group">
                        ...
                        <a href="<?php echo e(route('pemerintah.inovasi.create')); ?>" class="flex items-center p-3 rounded-lg border border-green-200 bg-green-50 hover:bg-green-100 transition-colors group">
                        ...
                        <a href="<?php echo e(route('program.innovation.list')); ?>" class="flex items-center p-3 rounded-lg border border-orange-200 bg-orange-50 hover:bg-orange-100 transition-colors group">
                        ...
                        <a href="<?php echo e(route('program.list')); ?>" class="flex items-center p-3 rounded-lg border border-purple-200 bg-purple-50 hover:bg-purple-100 transition-colors group">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-gray-900">
                                <?php echo e($programStats['total_programs'] + $programStats['total_innovations']); ?>

                            </span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-700">Update Terakhir</span>
                            <span class="text-sm text-gray-900"><?php echo e(now()->format('d/m/Y')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Counter Animation
        const counters = [
            { id: 'program-counter', target: <?php echo e($programStats['total_programs']); ?> },
            { id: 'inovasi-counter', target: <?php echo e($programStats['total_innovations']); ?> },
            { id: 'progress-counter', target: <?php echo e(round($averageProgramProgress)); ?> },
            { id: 'opd-counter', target: <?php echo e($programStats['active_opd']); ?> }
        ];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\dih_website\resources\views/pemerintah/index.blade.php ENDPATH**/ ?>