    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-gray-50 p-4 rounded-xl text-center">
                <div class="text-2xl font-bold text-blue-600 mb-1 font-mono"><?php echo e($stats['opd_terdaftar']); ?></div>
                <p class="text-gray-600 text-sm font-medium">OPD Terdaftar</p>
            </div>
            <div class="bg-gray-50 p-4 rounded-xl text-center">
                <div class="text-2xl font-bold text-green-600 mb-1 font-mono"><?php echo e($stats['akademisi_terdaftar']); ?></div>
                <p class="text-gray-600 text-sm font-medium">Akademisi Terdaftar</p>
            </div>
            <div class="bg-gray-50 p-4 rounded-xl text-center">
                <div class="text-2xl font-bold text-orange-500 mb-1 font-mono"><?php echo e($stats['program_selesai'] + $stats['program_berjalan']); ?></div>
                <p class="text-gray-600 text-sm font-medium">Program Dibuat</p>
            </div>
            <div class="bg-gray-50 p-4 rounded-xl text-center">
                <div class="text-2xl font-bold text-purple-600 mb-1 font-mono"><?php echo e($stats['total_inovasi']); ?>+</div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-md p-2 border border-gray-200 hover:border-blue-300 transition-colors">
                        <div class="flex items-start gap-2">
                            <div class="flex-shrink-0 w-16 h-16 rounded-md overflow-hidden">
                                ...
                                <img src="<?php echo e(asset('storage/' . $program->image)); ?>"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between mb-1">
                                    <span class="bg-blue-100 text-blue-800 text-xs font-bold px-1.5 py-0.5 rounded-full">
                                        <?php echo e($program->category ?? 'Umum'); ?>

                                    </span>
                                    <span class="text-xs text-gray-500"><?php echo e($program->created_at->diffForHumans()); ?></span>
                                </div>
                                <h4 class="text-xs font-bold mb-1 line-clamp-1"><?php echo e($program->title); ?></h4>
                                <p class="text-gray-600 text-xs mb-1 line-clamp-2"><?php echo e(Str::limit($program->description, 60)); ?></p>
                                
                                <div class="flex items-center justify-between">
                                    <span class="text-xs text-gray-500">Progress: <?php echo e($program->progress); ?>%</span>
            ...
            <div class="bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto scrollbar-hide">
                    <?php $__currentLoopData = $allInnovations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $innovation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-50 rounded-md p-2 border border-gray-200 hover:border-green-300 transition-colors">
                        <div class="flex items-start gap-2">
                            <div class="flex-shrink-0 w-16 h-16 rounded-md overflow-hidden">
                                ...
                                <img src="<?php echo e(asset('storage/' . $innovation->image)); ?>"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between mb-1">
                                    ...
                                    <span class="text-xs text-gray-500"><?php echo e($innovation->created_at->diffForHumans()); ?></span>
                                </div>
                                <h4 class="text-xs font-bold mb-1 line-clamp-1"><?php echo e($innovation->title); ?></h4>
                                <p class="text-gray-600 text-xs mb-1 line-clamp-2">
                                    <?php echo e(Str::limit($innovation->description, 60)); ?>

                                </p>
                                
                                <div class="flex items-center justify-between">
                                    <span class="text-xs text-gray-500">
                                        <?php if($innovation->technology_readiness_level): ?>
                                            TRL <?php echo e($innovation->technology_readiness_level); ?>
...
[$__name, $__params] = $__split('auth.user-login', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-887382256-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\dih_website\resources\views/landing/landing_page.blade.php ENDPATH**/ ?>