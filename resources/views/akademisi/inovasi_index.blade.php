...
<div class="w-full">
    ...
    <!-- HERO SECTION -->
    <section class="relative text-white py-24 overflow-hidden bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400">
        <!-- Overlay gradasi bawah -->
        <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-blue-700 opacity-50 pointer-events-none"></div>
        ...
        <div class="relative container mx-auto px-4 text-center z-10">
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4">
                Temukan <span class="bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text">Inovasi Terbaru</span>
            </h1>
            <p class="max-w-2xl mx-auto text-lg md:text-xl mb-10 opacity-90">
            ...
            <!-- FORM PENCARIAN -->
            <div class="bg-white/10 backdrop-blur-md p-6 rounded-xl max-w-4xl mx-auto shadow-lg">
                <form action="{{ route('akademisi.inovasi.index') }}" method="GET"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="q" value="{{ request('q') }}"
                               ...
                               class="p-3 rounded-lg border border-white/30 bg-white/10 placeholder-white/70 focus:outline-none focus:border-white/50 focus:bg-white/20 transition">
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="category"
                                class="p-3 rounded-lg border border-white/30 bg-white text-black cursor-pointer focus:outline-none focus:border-white/50 transition">
                    ...
                    <div class="flex items-end">
                        <button type="submit"
                                class="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg flex items-center justify-center gap-2 text-sm hover:bg-blue-700 transition transform hover:-translate-y-1">
    ...
    <div class="container mx-auto px-4 py-14 mt-8" id="inovasi-saya">
        ...
        @forelse($userInnovations as $year => $items)
            <div class="mb-12">
                <h3 class="text-xl font-semibold text-gray-700 border-b-4 border-gray-200 inline-block mb-6">
                    Tahun {{ $year }}
                </h3>
                        ...
                        <div class="bg-indigo-50 rounded-xl shadow hover:shadow-xl transition transform hover:-translate-y-2 flex flex-col overflow-hidden">
                            <div class="relative h-52 w-full">
                                ...
                                <span class="absolute top-3 right-3 px-2 py-1 rounded text-xs font-semibold text-white
                                    {{ $item->status == 'published' ? 'bg-green-500' : 'bg-yellow-400' }}">
                                    {{ ucfirst($item->status) }}
                                </span>
                            </div>
