                    ...
                    <div>
                        ...
                        <select name="assigned_to" class="w-full border-gray-300 rounded-lg p-2">
                            ...
                            @foreach($members as $member)
                                <option value="{{ $member->user_id }}">{{ optional($member->user)->name ?? 'Tanpa Nama' }}</option>
                            @endforeach
                            @if($leader)
                                <option value="{{ $leader->user_id }}">{{ optional($leader->user)->name ?? 'Leader' }}</option>
                            @endif
                            @if($pemilikIde)
                                <option value="{{ $pemilikIde->id }}">{{ $pemilikIde->name ?? 'Pemilik Ide' }}</option>
                            @endif
                        </select>
                    </div>
                    <div>
