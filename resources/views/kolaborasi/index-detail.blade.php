...
@section('title', 'Detail Kolaborasi Inovasi')
    ...
    <div class="container mx-auto px-6 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="menu-card">
                ...
                <a href="{{ route('kolaborasi.ide.show', $kolaborasi->id) }}">Buka</a>
            </div>
            ...
            <div class="menu-card">
                ...
                <a href="{{ route('kolaborasi.members.index', $kolaborasi->id) }}">Buka</a>
            </div>
            ...
            @if($isLeader)
                <div class="menu-card">
                    ...
                    <a href="{{ route('kolaborasi.tasks.index', $kolaborasi->id) }}">Buka</a>
                </div>
            @else
            ...
            <div class="menu-card">
                ...
                <a href="{{ route('kolaborasi.reviews.index', $kolaborasi->id) }}">Buka</a>
            </div>
        </div>
    </div>
</div>
