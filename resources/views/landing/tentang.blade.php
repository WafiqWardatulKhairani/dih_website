                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <p class="text-gray-700 text-sm">{{ $mission }}</p>
                            </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="hidden md:grid md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <div class="bg-white rounded-lg p-4 text-center card-hover">
                    <div class="w-16 h-16 bg-gradient-to-br {{ $member['color'] }} rounded-full mx-auto mb-3 flex items-center justify-center text-white shadow-md">
                        <i class="{{ $member['icon'] }}"></i>
                    </div>
                    <h3 class="font-bold text-gray-900 text-sm mb-1">{{ $member['name'] }}</h3>
                    <p class="text-blue-600 font-medium text-xs">{{ $member['role'] }}</p>
                </div>
                @endforeach
            </div>
            ...
            <div class="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                ...
                <div class="bg-white rounded-lg p-4 text-center card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 text-sm mb-1">{{ $member['name'] }}</h3>
                    <p class="text-green-600 font-medium text-xs">{{ $member['role'] }}</p>
                </div>
                @endforeach
            </div>
            ...
            <div class="md:hidden flex space-x-4 overflow-x-auto pb-4 -mx-4 px-4">
                ...
                <div class="bg-white rounded-lg p-4 text-center card-hover min-w-[140px] flex-shrink-0">
                    <div class="w-12 h-12 bg-gradient-to-br {{ $member['color'] }} rounded-full mx-auto mb-2 flex items-center justify-center text-white shadow-sm">
                        <i class="{{ $member['icon'] }} text-sm"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 text-xs mb-1 leading-tight">{{ $member['name'] }}</h3>
                    <p class="text-blue-600 font-medium text-xs">{{ $member['role'] }}</p>
                </div>
                @endforeach
            </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            <div class="bg-gray-50 rounded-lg p-4 flex items-center justify-center h-20 card-hover border border-gray-200">
                <span class="text-gray-700 font-medium text-center text-xs leading-tight">{{ $partner['abbr'] }}</span>
            </div>
            @endforeach
        </div>
    </div>
