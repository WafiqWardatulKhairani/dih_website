                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $user->institution_name }}</p>
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Member {{ $user->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
                                ...
                                <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="institution_name" value="{{ old('institution_name', $user->institution_name) }}" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300"
                                        ...
                                        <div>
                                            ...
                                            <textarea name="address" rows="3"
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300"
                                                placeholder="Alamat lengkap institusi">{{ old('address', $user->address) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold mt-2">{{ $stats['total_programs'] ?? 0 }}</p>
                                    <p class="text-blue-200 text-xs mt-1">
                                        {{ $stats['programs_last_year'] ?? 0 }} dalam setahun
                                    </p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold mt-2">{{ $stats['total_innovations'] ?? 0 }}</p>
                                    <p class="text-green-200 text-xs mt-1">
                                        {{ $stats['innovations_last_year'] ?? 0 }} dalam setahun
                                    </p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xl font-bold mt-2">
                                        @if(($stats['total_budget'] ?? 0) >= 1000000000)
                                        Rp {{ number_format(($stats['total_budget'] ?? 0) / 1000000000, 1) }}M
                                        @elseif(($stats['total_budget'] ?? 0) >= 1000000)
                                        Rp {{ number_format(($stats['total_budget'] ?? 0) / 1000000, 1) }}Jt
                                        @else
                                        Rp {{ number_format($stats['total_budget'] ?? 0, 0) }}
                                        @endif
                                    </p>
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                ...
                                <a href="{{ route('program.detail', $program->id) }}" class="block">
                                        ...
                                        <div class="flex items-center justify-between text-xs">
                                            <div class="flex items-center space-x-3">
                                                <span class="px-2 py-1 rounded-full font-medium 
                                                        ...
                                                        @elseif($program->status === 'ongoing') bg-blue-100 text-blue-800
                                                        @else bg-yellow-100 text-yellow-800 @endif">
                                                    {{ ucfirst($program->status) }}
                                                </span>
                                                <span class="text-gray-500">{{ $program->progress ?? 0 }}%</span>
                                            </div>
                                            <span class="text-gray-400 text-xs">{{ $program->created_at->format('d M Y') }}</span>
                                        </div>
                                    </div>
                                </a>
                                @endforeach
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                ...
                                <a href="{{ route('program.innovation.detail', $innovation->id) }}" class="block">
                                    <div class="group bg-white rounded-xl p-4 border border-gray-200 hover:border-green-300 hover:shadow-lg transition-all duration-300 h-full">
                                        ...
                                        <div class="flex items-center justify-between text-xs">
                                            <div class="flex items-center space-x-3">
                                                <span class="px-2 py-1 rounded-full font-medium 
                                                        @if($innovation->status === 'published') bg-green-100 text-green-800
                                                        @elseif($innovation->status === 'draft') bg-gray-100 text-gray-800
                                                        @else bg-yellow-100 text-yellow-800 @endif">
                                                    {{ ucfirst($innovation->status) }}
                                                </span>
                                                <span class="text-gray-500">{{ $innovation->category ?? 'General' }}</span>
                                            </div>
                                            <span class="text-gray-400 text-xs">{{ $innovation->created_at->format('d M Y') }}</span>
                                        </div>
                                    </div>
                                </a>
                                @endforeach
                        ...
                        <div class="bg-gradient-to-br from-pink-500 to-pink-600 text-white rounded-2xl p-6 shadow-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xl font-bold mt-2">
                                        @if(isset($stats['innovations_by_category']) && count($stats['innovations_by_category']) > 0)
                                        {{ array_key_first($stats['innovations_by_category']->toArray()) }}
                                        @else
                                        -
                                        @endif
                                    </p>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-6">
                            <h4 class="text-xl font-bold text-gray-900 flex items-center">
                                ...
                                Inovasi Akademik ({{ $innovations->total() }})
                            </h4>
                        </div>
